    ...
    public partial class opiskelijaForm : Form
    {
        ...
        private void PaivitaBT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (lisaaAsiakas)
                {
                    MessageBox.Show("Opiskelija päivitetty onnistuunesti", "Opiskelijan päivitys", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        private void sukuLB_Click(object sender, EventArgs e)
        {
